    ...
    return (
        <div className="border-b-[1px] border-neutral-800 px-5 py-2">
            {currentUser ? (
                <div className="flex flex-row gap-4">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div>
                            <Button disabled={isLoading || !body} onClick={onSubmit} label="Twittar "/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="py-8">
                    <h1 className="text-white text-2xl text-center mb-4 font-bold">Twitter Clone</h1>
                    <div className="flex flex-row items-center justify-center gap-4">
                        <Button label="Login" onClick={loginModal.onOpen}/>
                        <Button label="Registro" onClick={registerModal.onOpen} secondary />
                    </div>
                </div>
            )}
        </div>
